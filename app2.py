...
@media (max-width: 768px){
    ...
    .izw-table tbody tr{
        ...
        border:1px solid #17485f!important;
        border-radius:10px!important;
        background:
            linear-gradient(145deg,#071724,#081d2a)!important;
        box-shadow:
            inset 0 1px 0 rgba(255,255,255,.025),
            0 8px 20px rgba(0,0,0,.12)!important;
    }

    .izw-table tbody tr:hover td{
...
/* =========================================================
   ...
   ========================================================= */
.iz-scan-lock-overlay{position:fixed;inset:0;z-index:2147483000;display:flex;align-items:center;justify-content:center;padding:24px;background:rgba(2,8,14,.82);backdrop-filter:blur(9px);-webkit-backdrop-filter:blur(9px);pointer-events:all;cursor:wait}
...
.iz-scan-lock-pulse{width:8px;height:8px;border-radius:50%;background:#36d6df;box-shadow:0 0 0 0 rgba(54,214,223,.55);animation:izScanPulse 1.45s infinite}
@keyframes izScanPulse{0%{box-shadow:0 0 0 0 rgba(54,214,223,.55)}70%{box-shadow:0 0 0 9px rgba(54,214,223,0)}100%{box-shadow:0 0 0 0 rgba(54,214,223,0)}}
...
@media(max-width:600px){.iz-scan-lock-overlay{padding:14px}.iz-scan-lock-card{width:100%;padding:20px 18px 17px;border-radius:10px}.iz-scan-lock-card h2{font-size:20px}.iz-scan-lock-card p{font-size:10px;margin-bottom:14px}.iz-scan-lock-meta{align-items:flex-start;flex-direction:column;gap:3px}.iz-scan-lock-meta span{text-align:left;font-size:8px}}

/* =========================================================
   v1.7.57 — SORTABLE SCAN TABLE
   Streamlit dataframe theme harmonization
   ========================================================= */

[data-testid="stDataFrame"]{
    border:1px solid #16465d!important;
...
/* Mobilde tablo kullanımı: yatay kaydırma doğal kalsın, font aşırı küçülmesin. */
@media(max-width:768px){
    [data-testid="stDataFrame"]{
        font-size:10px!important;
    }
