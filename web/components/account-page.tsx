  ...
  return <main className="account-page" aria-label="Gizlilik ve hesap merkezi">
    ...
    <section className="account-layout">
      ...
      <aside className="account-side">
        ...
        <section className="account-panel"><p className="eyebrow">HESAP GÜVENLİĞİ</p><h3>Kimlik sınırı</h3><p>Hesap işlemleri güvenli kimlik doğrulamayla korunur; silme işlemi yalnızca doğrulanmış kullanıcının kendi hesabı ve e-posta adresi için çalışır.</p></section>
      </aside>
    </section>
  </main>;
}
